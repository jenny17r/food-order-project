...
import com.example1.foodiesapi.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService{
    ...
    public OrderResponse createOrderWithPayment(OrderRequest request) throws RazorpayException {
        ...
        System.out.println("RAZORPAY_KEY = " + RAZORPAY_KEY);
        System.out.println("RAZORPAY_SECRET = " + RAZORPAY_SECRET);
    ...
    /*private OrderEntity convertToEntity(OrderRequest request) {
        ...
        double totalAmount = request.getOrderedItems().stream()
                .mapToDouble(item -> item.getPrice() * item.getQuantity())
                .sum();

        return OrderEntity.builder()
                .userAddress(request.getUserAddress())
                .amount(totalAmount)   // ✅ calculated, never null
                .orderedItems(request.getOrderedItems())
                .email(request.getEmail())
                .phoneNumber(request.getPhoneNumber())
                .orderStatus(request.getOrderStatus())
